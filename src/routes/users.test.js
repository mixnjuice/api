...
describe('users route resource', () => {
  ...
  it(
    'returns 400 for invalid user list',
    tryCatch((done) => {
  ...
  it(
    'returns valid list of 2 user accounts',
    tryCatch((done) => {
  ...
  it(
    'returns 200 for user accounts list',
    tryCatch((done) => {
  ...
  it(
    'returns 400 for invalid user accounts list',
    tryCatch((done) => {
  ...
  it(
    'returns 200 for roles users list',
    tryCatch((done) => {
