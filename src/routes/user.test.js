...
describe('user route resource', () => {
  ...
  it(
    'GET returns valid user profile',
    tryCatch((done) => {
  ...
  it(
    'GET returns valid user recipes',
    tryCatch((done) => {
  ...
  it(
    'GET returns valid user flavors',
    tryCatch((done) => {
  ...
  it(
    'GET returns valid user flavor note',
    tryCatch((done) => {
      request.get('/10/note/23').expect(200, done);
    })
  );

  it(
    'POST creates user flavor note',
    tryCatch((done) => {
      request
        .post('/10/note')
        .send({
  ...
  it(
    'DELETE destroys a user flavor note',
    tryCatch((done) => {
      request.delete('/10/note/23').expect(200, done);
    })
  );

  it(
    'GET returns valid user flavor notes',
    tryCatch((done) => {
      request.get('/10/notes').expect(200, done);
    })
  );

  it(
    'GET returns valid user roles',
    tryCatch((done) => {
