...
describe('vendors route resource', () => {
  ...
  it(
    'returns valid vendors limit 20',
    tryCatch((done) => {
  ...
  it(
    'returns 400 for invalid vendors',
    tryCatch((done) => {
  ...
  it(
    'returns 400 for invalid vendors #2',
    tryCatch((done) => {
