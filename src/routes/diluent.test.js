...
describe('diluent route resource', () => {
  ...
  it(
    'POST returns 200 for creating diluent',
    tryCatch((done) => {
      request
        .post('/')
        .send(mockData)
  ...
  it(
    'GET returns 200 for valid diluent',
    tryCatch((done) => {
  ...
  it(
    'PUT returns 200 for updating diluent',
    tryCatch((done) => {
      request
        .put('/3')
        .send(mockData)
  ...
  it(
    'PUT returns 404 for updating without an id',
    tryCatch((done) => {
  ...
  it(
    'GET returns 400 for invalid diluent',
    tryCatch((done) => {
  ...
  it(
    'GET returns 400 for invalid diluent #2',
    tryCatch((done) => {
  ...
  it(
    'DELETE returns 200 after deleting diluent',
    tryCatch((done) => {
